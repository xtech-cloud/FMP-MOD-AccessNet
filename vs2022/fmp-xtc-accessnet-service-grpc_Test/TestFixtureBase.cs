...
public abstract class TestFixtureBase : IDisposable
{
    ...
    protected PointService? servicePoint_ { get; set; }

    public PointService getServicePoint()
    {
        if(null == servicePoint_)
        {
            newPointService();
        }
        return servicePoint_!;
    }
    ...
    /// </summary>
    /// <example>
    /// servicePoint_ = new PointService(new PointDAO(new DatabaseOptions()));
    /// </example>
    protected abstract void newPointService();
